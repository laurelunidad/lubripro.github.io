		...
		<div class="col-lg-6">
			<div class="card">
				...
				<div class="card-body">
					...
					<ul class="list-group">
						<li class="card-header bg-dark text-white">Cambiar Contraseña</li>
						<form action="" method=" post" name="frmChangePass" id="frmChangePass" class="p-3">
							...
							<div>
								<button type="submit" class="btn btn-dark btnChangePass">Cambiar Contraseña</button>
							</div>
						</form>
					</ul>
				</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							...
							<div>
								<button type="submit" class="btn btn-dark btnChangePass"><i class="fas fa-save"></i> Guardar Datos</button>
							</div>
