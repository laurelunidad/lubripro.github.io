                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <a href="#" class="btn btn-warning btn_new_cliente"><i class="fas fa-user-plus"></i> Nuevo Cliente</a>
                            </div>
                            <div class="card">
                                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div id="acciones_venta" class="form-group">
                                        ...
                                        <a href="#" class="btn btn-warning" id="btn_facturar_venta"><i class="fas fa-save"></i> Generar Venta</a>
                                    </div>
                                </div>
                            </div>
