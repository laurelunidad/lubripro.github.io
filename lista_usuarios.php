...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="registro_usuario.php" class="btn btn-warning">Nuevo</a>
		<?php } ?>
	</div>
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<?php if ($_SESSION['rol'] == 1) { ?>
									<td>
										<a href="editar_usuario.php?id=<?php echo $data['idusuario']; ?>" class="btn btn-warning"><i class='fas fa-edit'></i> Editar</a>
